    ...
    render() {
        ...
        return (
            ...
            {/* onPress={() => this.props.navigation.goBack()} */}
                ...
                <SocialButton testID='login' socialTitle="الدخول عبر حساب فيسبوك" 
                ...
                {/* <View style={{flex:1}}> */}
                    <Form title="أو الدخول عبر البريد الإلكتروني">
                     ...
                     <Text testID='log-in' onPress={()=>this.props.navigation.navigate("HomeStackNavigator")}>تسجيل الدخول</Text> 
